...
public interface TaskCommentQuery extends BaseQuery<TaskComment, TaskCommentQueryColumnName> {
  ...
  /**
   * Add your {@linkplain pro.taskana.task.api.models.Task}ids to your query.
   *
   * @param taskIds the {@linkplain pro.taskana.task.api.models.Task} ids as Strings
   * @return the query
   */
  TaskCommentQuery taskIdIn(String... taskIds);

  /**
   * Add your {@linkplain pro.taskana.task.api.models.Task} ids for pattern matching to your query.
   * It will be compared in SQL with the LIKE operator. You may use a wildcard like % to specify the
   * pattern. If you specify multiple arguments they are combined with the OR keyword.
   *
   * @param taskIds your {@linkplain pro.taskana.task.api.models.Task} ids
   * @return the query
   */
