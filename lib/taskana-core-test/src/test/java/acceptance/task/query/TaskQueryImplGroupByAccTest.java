...
public class TaskQueryImplGroupByAccTest implements TaskanaConfigurationModifier {
  ...
  @WithAccessId(user = "user-1-1")
  @Test
  void should_UseListValuesCorrectly_When_GroupingByPor() {
    List<String> result =
        taskService
            .createTaskQuery()
            .workbasketIdIn(defaultWorkbasket.getId())
            .groupByPor()
            .listValues(TaskQueryColumnName.GROUP_BY_COUNT, SortDirection.ASCENDING);
  ...
  @WithAccessId(user = "user-1-1")
  @Test
  void should_UseListValuesCorrectly_When_GroupingBySor() {
    List<String> result =
        taskService
            .createTaskQuery()
            .workbasketIdIn(defaultWorkbasket.getId())
